...
<div class="container py-5">
    ...
    <form action="{{ route('kejadian.update', $kejadian->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <textarea name="deskripsi" class="form-control" rows="4" required>{{ old('deskripsi', $kejadian->deskripsi) }}</textarea>
        </div>

        <div class="mb-3">
            <label class="form-label">Gambar</label><br>
            @if($kejadian->gambar)
                <img src="{{ asset('storage/'.$kejadian->gambar) }}" alt="Gambar" width="200" class="mb-3">
            @endif
